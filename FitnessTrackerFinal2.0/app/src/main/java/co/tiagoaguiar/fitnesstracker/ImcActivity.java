...
public class ImcActivity extends AppCompatActivity {
    ...
    private void setEvents() {
        btnSend.setOnClickListener(view -> {
            ...
            AlertDialog dialog = getDialog(result, imcResponseId);
	...
	private AlertDialog getDialog(double result, int imcResponseId) {
		return new AlertDialog.Builder(ImcActivity.this)
